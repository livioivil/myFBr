##' Funzione che dato il percorso dei dati del profilo facebook ritorna il numero di posti in cui si è stati compresi fra 2 date
##'
...
##' @return numero di posti dove ci si è segnalati dopo la data di riferimento compresi fra 2 date
##' 
##' @author Davide Meneghetti

getPostiData2 <-function(percorso,dataI,dataF){
