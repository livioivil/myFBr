##' Funzione che dato il percorso dei dati del profilo facebook ritorna il numero di post sulla bacheca compresi fra 2 date
##' 
...
getNPostData2 <- function(percorso,dataI,dataF){
